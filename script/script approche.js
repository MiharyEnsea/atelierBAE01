...
function changeEnvironnement2(){
	...
	sec.innerHTML='<div class="col-6 d-none d-md-block"></div> <div class="col-md-6 col-12 fs-2">'+
				...
				'</div>'+
			'</div>'+
			'<div id="schema" class="col-md-3 col-6 d-none d-md-block anime1">'+
				'<img src="./Images/vélo origine.png">'+
				"<h5>Vélo vintage</h5>"+
				"<p>déjà existante => 0 émission de CO<sub>2</sub> supplémentaire</p>"+
			"</div>"+
			'<div id="schema" class="col-md-3 col-6 d-none d-md-block anime2">'+
				'<img src="./Images/Composants gardés.png">'+
				'<h5>Pièces conservées</h5>'+
				"<p>autant que possible si leur état le permet</p>"+
			"</div>"+
			'<div id="schema" class="col-md-3 col-6 d-none d-md-block anime3">'+
				'<img src="./Images/Appro composants.png">'+
				"<h5>Composants achetés</h5>"+
				"<p>optimisés pour limiter le transport longue distance</p>"+
			"</div>"+
			'<div id="schema" class="col-md-3 col-6 d-none d-md-block anime4">'+
				'<img src="./Images/BAE assemblée.png">'+				
				"<h5>Assemblage</h5>"+
				"<p>réalisé localement, en atelier / boutique</p>"+
			'</div>'+
			'<div id="carouselExampleSlidesOnly" class="carousel slide d-block d-md-none" data-bs-ride="carousel">'+
				'<div class="carousel-inner">'+
					'<div class="carousel-item active" data-bs-interval="2000">'+
						'<img src="./Images/vélo origine.png" class="d-block w-100">'+
						"<h5>Vélo vintage</h5>"+
						"<p>déjà existante => 0 émission de CO<sub>2</sub> supplémentaire</p>"+
					'</div>'+
					'<div class="carousel-item" data-bs-interval="2000">'+
						'<img src="./Images/Composants gardés.png" class="d-block w-100">'+
							"<h5>Pièces conservées </h5>"+
							"<p>autant que possible si leur état le permet</p>"+
					'</div>'+
					'<div class="carousel-item" data-bs-interval="2000">'+
						'<img src="./Images/Appro composants.png" class="d-block w-100">'+
							"<h5>Composants achetés</h5>"+
							"<p>optimisés pour limiter le transport longue distance</p>"+
					'</div>'+
					'<div class="carousel-item" data-bs-interval="2000">'+
						'<img src="./Images/BAE assemblée.png" class="d-block w-100">'+
							"<h5>Assemblage</h5>"+
							"<p>réalisé localement, en atelier / boutique</p>"+
					'</div>'+
				'</div>'+
